...
# Continuous variables are numeric variables that have an almost infinite
# number of possibilities, such as age, weight, and time

#------------------------
# Your turn! 
#------------------------

# Look in the dataframe schools, and find two examples of 
...
# The attach() function allows us to simplify our code by 
# removing the need to refer to the name of the dataframe 
...
# Notice that the mean() function is working without the 
